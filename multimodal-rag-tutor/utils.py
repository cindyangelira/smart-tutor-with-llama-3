...
def process_graph(image_content):
    ...
    response = mixtral.complete("You are an AI smart tutor that has responsibility is to explain charts to students. You are an expert in describing the responses of linearized tables into plain English text for LLMs to use. Explain the following linearized table. " + deplot_description)
